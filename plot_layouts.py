...
class ScatterPlot2D(QVBoxLayout):
    ...
    def _init_plot_widget(self):
        ...
        self._plotWidget.scene().contextMenuItem = self._plotWidget.getViewBox()
        # self._plotWidget.resizeEvent = self.resizeEvent
    ...
    def export(self):
        self._plotWidget.scene().showExportDialog()
